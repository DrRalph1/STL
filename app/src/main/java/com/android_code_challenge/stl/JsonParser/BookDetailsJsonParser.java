...
import com.android_code_challenge.stl.Adapter.BookDetailsAdapter;
...
public class BookDetailsJsonParser extends AsyncTask<String, String, Void> {
    ...
    public BookDetailsJsonParser(Activity activity, Context context, String url){
    ...
    protected void onPostExecute(Void aVoid) {
        try{
                ...
                try {
                    ...
                    while (iterDetails.hasNext()) {
                        ...
                        try {
                            ...
                            // Set Description
                            JSONObject description = new JSONObject(details.getString("description"));
                            Iterator<String> iterDescription = details.keys();
                            while (iterDescription.hasNext()) {
                                String descriptionsKey = iterDescription.next();
                                try {

                                    bookDetails.description = description.getString("value");
                            ...
                            bookDetails.yearOfPublication = "Year of Publication : " + details.getString("publish_date");
            ...
            ListView listView;
            listView = (ListView) this.activity.findViewById(R.id.bookDetails);
            BookDetailsAdapter adapter = new BookDetailsAdapter(this.context, books);
